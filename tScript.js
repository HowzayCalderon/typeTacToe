...
playerX === null || playerX === void 0 ? void 0 : playerX.addEventListener('click', () => {
    activePlayer = "X";
...
playerO === null || playerO === void 0 ? void 0 : playerO.addEventListener('click', () => {
    activePlayer = "O";
    playerO.className = "hidden";
